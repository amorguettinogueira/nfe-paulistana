...
/// <summary>
/// <para>Configurações para a ação <see cref="Actions.QueryCnpjV2Action"/>.</para>
/// <para>
/// Observação: esta classe é estruturalmente idêntica a
/// <see cref="QueryCnpjV1Options"/> (apenas a seção de configuração
...
/// </para>
/// </summary>
internal sealed class QueryCnpjV2Options
{
    /// <summary>
    ...
    /// Chave User Secrets: <c>ConsultaCnpjV2:CnpjAConsultar</c>.
    /// </summary>
    [Required(ErrorMessage = $"{nameof(AppSettings.ConsultaCnpjV2)}.{nameof(CnpjAConsultar)} é obrigatório.")]
