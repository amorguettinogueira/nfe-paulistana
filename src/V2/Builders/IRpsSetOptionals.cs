...
/// Exposto após <see cref="IRpsSetIbsCbs.SetIbsCbs"/> e permite o preenchimento de todos os
...
public interface IRpsSetOptionals
{
    ...
    /// <param name="valorIpi">IPI — Imposto sobre Produtos Industrializados.</param>
    /// <returns>Esta mesma instância para encadeamento.</returns>
    /// <exception cref="ArgumentException">Se todos os parâmetros forem nulos.</exception>
    ...
    /// <summary>Adiciona o valor da multa ao RPS.</summary>
    ...
    IRpsSetOptionals SetMulta(Valor valorMulta);

    /// <summary>Adiciona o valor dos juros ao RPS.</summary>
    ...
    IRpsSetOptionals SetJuros(Valor valorJuros);

    /// <summary>Adiciona o código NCM (Nomenclatura Comum do Mercosul) ao RPS.</summary>
    /// <param name="ncm">Código NCM.</param>
    /// <returns>Esta mesma instância para encadeamento.</returns>
    /// <exception cref="ArgumentNullException">Se <paramref name="ncm"/> for nulo.</exception>
    IRpsSetOptionals SetNcm(CodigoNCM ncm);

    /// <summary>Adiciona informações de atividade de evento ao RPS.</summary>
    ...
    IRpsSetOptionals SetAtividadeEvento(AtividadeEvento atividadeEvento);
    ...
    /// Série do RPS, Data de emissão, Status da NF-e, Tipo de tributação,
    /// Código do serviço, Alíquota do ISS, Indicador de retenção do ISS, NBS,
    /// IBS/CBS ou Tomador de serviços.
    /// </exception>
    Rps Build();
}