...
/// <summary>
/// Sexto e último passo obrigatório da cadeia de construção do <see cref="Rps"/>.
/// Exposto após <see cref="IRpsSetValorCobrado.SetValorInicialCobrado"/> ou <see cref="IRpsSetValorCobrado.SetValorFinalCobrado"/>
/// e requer a chamada de <see cref="SetLocalPrestacao"/> ou <see cref="SetPaisPrestacao"/>
