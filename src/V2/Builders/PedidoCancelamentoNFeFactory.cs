...
/// <summary>
/// Fábrica para construir objetos <see cref="PedidoCancelamentoNFe"/> v02 com geração automática
...
public sealed class PedidoCancelamentoNFeFactory(Certificado certificate)
{
    ...
    /// <summary>
    /// Cria um <see cref="PedidoCancelamentoNFe"/> totalmente assinado a partir de um CNPJ alfanumérico.
    /// </summary>
