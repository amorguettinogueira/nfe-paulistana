...
/// <summary>
/// Representa a requisição de consulta de NFS-e (<c>ConsultaNFeRequest</c>) para o
...
public sealed class ConsultaNFeRequest
{
    ...
    /// <inheritdoc cref="FromPedidoConsultaNFe"/>
    public static explicit operator ConsultaNFeRequest(PedidoConsultaNFe value) => FromPedidoConsultaNFe(value);
}