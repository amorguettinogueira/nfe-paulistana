...
/// da NF-e Paulistana v02 (<c>tpNFe</c>).
/// </summary>
/// <remarks>
/// Fonte: <c>TiposNFe_v02.xsd</c> — Tipo complexo <c>tpNFe</c>.
...
public sealed class NfeModel
{
    ...
    /// <summary>Código do município da prestação do serviço. Opcional.</summary>
    [XmlElement("MunicipioPrestacao", Namespace = "")]
    public string? MunicipioPrestacao { get; set; }

    /// <summary>Número do encapsulamento da obra. Opcional.</summary>
    ...
    /// <summary>Valor inicial cobrado pela prestação do serviço, antes de tributos. Opcional.</summary>
    [XmlElement("ValorInicialCobrado", Namespace = "")]
    public string? ValorInicialCobrado { get; set; }

    /// <summary>Valor final cobrado pela prestação do serviço, incluindo todos os tributos. Opcional.</summary>
    [XmlElement("ValorFinalCobrado", Namespace = "")]
    public string? ValorFinalCobrado { get; set; }

    /// <summary>Valor da multa. Opcional.</summary>
    [XmlElement("ValorMulta", Namespace = "")]
    public string? ValorMulta { get; set; }

    /// <summary>Valor dos juros. Opcional.</summary>
    [XmlElement("ValorJuros", Namespace = "")]
    public string? ValorJuros { get; set; }

    /// <summary>Valor de IPI. Opcional.</summary>
    [XmlElement("ValorIPI", Namespace = "")]
    public string? ValorIpi { get; set; }

    /// <summary>Indica se é uma emissão com exigibilidade suspensa.</summary>
    [XmlElement("ExigibilidadeSuspensa", Namespace = "")]
    public string? ExigibilidadeSuspensa { get; set; }

    /// <summary>Indica nota fiscal de pagamento parcelado antecipado.</summary>
    [XmlElement("PagamentoParceladoAntecipado", Namespace = "")]
    public string? PagamentoParceladoAntecipado { get; set; }

    /// <summary>Número NCM (Nomenclatura Comum do Mercosul). Opcional.</summary>
    [XmlElement("NCM", Namespace = "")]
    public string? Ncm { get; set; }

    /// <summary>Número NBS (Nomenclatura Brasileira de Serviços). Opcional.</summary>
    [XmlElement("NBS", Namespace = "")]
