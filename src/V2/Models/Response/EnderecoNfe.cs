...
/// <summary>
/// Endereço retornado pelo webservice da NF-e Paulistana v02 no contexto de resposta (<c>tpEndereco</c>).
/// </summary>
/// <remarks>
/// Difere de <c>Nfe.Paulistana.V2.Models.Domain</c> por usar tipos primitivos
...
/// Fonte: <c>TiposNFe_v02.xsd</c> — Tipo <c>tpEndereco</c>.
/// </remarks>
