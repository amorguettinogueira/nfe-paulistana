...
/// <summary>
/// Define o corpo da requisição de cancelamento de NFS-e v02 (<c>PedidoCancelamentoNFe</c>).
...
/// <remarks>
/// <para>
/// Fonte: <c>PedidoCancelamentoNFe_v02.xsd</c> — Elemento <c>PedidoCancelamentoNFe</c>.
/// </para>
/// <para>
/// Representa uma solicitação de cancelamento de até 50 NFS-e à Prefeitura de São Paulo.
/// Instâncias devem ser criadas via
/// <see cref="Nfe.Paulistana.V2.Builders.PedidoCancelamentoNFeFactory"/>, que garante
...
public sealed class PedidoCancelamentoNFe : ISignedXmlFile, IXmlValidatableSchema
{
    private static readonly XmlSchemaSet _validationSchema =
        SchemaProvider.GetSchemaSetV2(Constants.Uris.Nfe, "PedidoCancelamentoNFe_v02.xsd");
