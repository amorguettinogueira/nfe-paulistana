...
/// <summary>
/// Define o corpo da requisição de consulta de NFS-e v02 (<c>PedidoConsultaNFe</c>).
...
/// <remarks>
/// <para>
/// Fonte: <c>PedidoConsultaNFe_v02.xsd</c> — Elemento <c>PedidoConsultaNFe</c>.
/// </para>
/// <para>
...
public sealed class PedidoConsultaNFe : ISignedXmlFile, IXmlValidatableSchema
{
    private static readonly XmlSchemaSet _validationSchema =
        SchemaProvider.GetSchemaSetV2(Constants.Uris.Nfe, "PedidoConsultaNFe_v02.xsd");
