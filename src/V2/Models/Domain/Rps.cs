...
public sealed class Rps : ISignedElement
{
    ...
    public Rps(ChaveRps chaveRps,
                            ...
                            CodigoNBS nbs,
                            InformacoesIbsCbs ibsCbs,
                            Valor? valorInicialCobrado = null,
                            Valor? valorFinalCobrado = null,
                            CpfOrCnpjOrNif? cpfCnpjNifTomador = null,
                            ...
                            Valor? valorMulta = null,
                            Valor? valorJuros = null,
                            CodigoNCM? ncm = null,
                            AtividadeEvento? atividadeEvento = null,
                            CodigoIbge? municipioPrestacaoServico = null,
                            CodigoPaisISO? paisPrestacaoServico = null)
    {
        ...
        IssRetido = issRetido;
        CpfCnpjNifTomador = cpfCnpjNifTomador;
        ...
        LocalPrestacaoServico = municipioPrestacaoServico;
        PaisPrestacaoServico = paisPrestacaoServico;
        IbsCbs = ibsCbs;
    }
    ...
    public CpfOrCnpjOrNif? CpfCnpjNifTomador { get; set; }
    ...
    public bool? IssRetidoIntermediario
    {
        ...
        set
        {
            ...
            IssRetidoIntermediarioSpecified = value.HasValue;
        }
    }
    ...
    /// <summary>Valor inicial cobrado pelo prestador. Mutuamente exclusivo com <see cref="ValorFinalCobrado"/>.</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public Valor? ValorInicialCobrado { get; set; }

    /// <summary>Valor final cobrado pelo prestador. Mutuamente exclusivo com <see cref="ValorInicialCobrado"/>.</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public Valor? ValorFinalCobrado { get; set; }

    /// <summary>Valor da multa.</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public Valor? ValorMulta { get; set; }

    /// <summary>Valor dos juros.</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public Valor? ValorJuros { get; set; }

    /// <summary>Valor de IPI.</summary>
    [XmlElement("ValorIPI", Form = XmlSchemaForm.Unqualified)]
    public Valor ValorIpi { get; set; }

    /// <summary>Informe se é uma emissão com exigibilidade suspensa.</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public NaoSim ExigibilidadeSuspensa { get; set; }

    /// <summary>Informe a nota fiscal de pagamento parcelado antecipado (realizado antes do fornecimento).</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public NaoSim PagamentoParceladoAntecipado { get; set; }

    /// <summary>Informe o número NCM (Nomenclatura Comum do Mercosul).</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public CodigoNCM? NCM { get; set; }

    /// <summary>Informe o número NBS (Nomenclatura Brasileira de Serviços).</summary>
    [XmlElement(Form = XmlSchemaForm.Unqualified)]
    public CodigoNBS? NBS { get; set; }

    /// <summary>Informações dos Tipos de evento.</summary>
    [XmlElement("atvEvento", Form = XmlSchemaForm.Unqualified)]
    public AtividadeEvento? AtividadeEvento { get; set; }

    /// <summary>Código IBGE do local de prestação do serviço.</summary>
    [XmlElement("cLocPrestacao", Form = XmlSchemaForm.Unqualified)]
    public CodigoIbge? LocalPrestacaoServico { get; set; }

    /// <summary>Código ISO do país de prestação do serviço.</summary>
    [XmlElement("cPaisPrestacao", Form = XmlSchemaForm.Unqualified)]
    public CodigoPaisISO? PaisPrestacaoServico { get; set; }

    /// <summary>Informações declaradas pelo emitente referentes ao IBS e à CBS.</summary>
    [XmlElement("IBSCBS", Form = XmlSchemaForm.Unqualified)]
    public InformacoesIbsCbs? IbsCbs { get; set; }
}