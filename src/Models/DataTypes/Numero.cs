...
public sealed class Numero : XmlSerializableDataType
{
    ...
    /// caso contrário, cria uma instância de <see cref="Numero"/>.
    /// </summary>
    /// <param name="value">Número como string, possivelmente nulo ou vazio.</param>
    /// <returns>Nova instância de <see cref="Numero"/> ou <see langword="null"/>.</returns>
    /// <exception cref="ArgumentException">Se <paramref name="value"/> for inválido.</exception>
    public static Numero? ParseIfPresent(string? value) =>
    ...
    /// caso contrário, cria uma instância de <see cref="Numero"/>.
    /// </summary>
    /// <param name="value">Número como número inteiro long, possivelmente nulo.</param>
    /// <returns>Nova instância de <see cref="Numero"/> ou <see langword="null"/>.</returns>
    /// <exception cref="ArgumentException">Se <paramref name="value"/> estiver fora do intervalo válido.</exception>
    public static Numero? ParseIfPresent(long? value) =>
