...
/// <summary>
/// Cabeçalho do pedido de consulta de NFS-e por período (<c>PedidoConsultaNFePeriodo</c>).
...
/// <remarks>
/// <para>
/// Fonte: <c>PedidoConsultaNFePeriodo_v01.xsd</c> — Elemento <c>Cabecalho</c>.
/// </para>
/// <para>
/// Compartilhado pelas operações <c>ConsultaNFeRecebidas</c> (filtra pelo tomador)
/// e <c>ConsultaNFeEmitidas</c> (filtra pelo prestador).
/// </para>
/// </remarks>
[Serializable]
