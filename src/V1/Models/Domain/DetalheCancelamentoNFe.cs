...
/// <summary>
/// Detalhe do pedido de cancelamento de NFS-e, contendo a chave de identificação
/// da NFS-e e a assinatura de cancelamento. Representa o elemento inline <c>Detalhe</c>
/// de <c>PedidoCancelamentoNFe</c>.
/// </summary>
/// <remarks>
/// <para>
/// Fonte: <c>PedidoCancelamentoNFe_v01.xsd</c> — Elemento <c>Detalhe</c> (1–50 ocorrências).
/// </para>
/// <para>
...
public sealed class DetalheCancelamentoNFe : ISignedElement
{
    ...
    /// <summary>
    /// Inicializa o detalhe com a chave da NFS-e a ser cancelada.
    /// </summary>
