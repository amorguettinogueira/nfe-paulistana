...
/// <summary>
/// Construtor fluente de objetos <see cref="Tomador"/> com cinco pontos de entrada distintos
/// conforme a identificação do tomador: CPF, CNPJ, Inscrição Municipal, Inscrição Estadual
...
/// <see cref="NewCnpj"/>, <see cref="NewInscricaoMunicipal"/>, <see cref="NewInscricaoEstadual"/>
/// ou <see cref="NewRazaoSocial(RazaoSocial)"/>). Cada método aceita apenas os campos pertinentes
/// à identificação escolhida.
/// </item>
/// <item>
