...
/// <summary>
/// Representa a requisição de cancelamento de NFS-e (<c>CancelamentoNFeRequest</c>) para o webservice
...
public sealed class CancelamentoNFeRequest
{
    ...
    /// <summary>
    /// Operador de conversão explícita de <see cref="PedidoCancelamentoNFe"/> para <see cref="CancelamentoNFeRequest"/>.
    /// </summary>
